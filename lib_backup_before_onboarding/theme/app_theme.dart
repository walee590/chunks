...
class AppTheme {
  ...
  static const List<Color> noteAccentColors = [
    Color(0xFF4A4D51), // 0 - Default accent (Darker Grey)
    Color(0xFFCD6B62), // 1 - Coral (Muted)
    Color(0xFF5FBDBD), // 2 - Teal (Muted)
    Color(0xFFB78EFB), // 3 - Lavender (Muted)
    Color(0xFFACDF70), // 4 - Mint (Muted)
    Color(0xFFDB9C04), // 5 - Peach (Muted)
    Color(0xFF8EABFA), // 6 - Sky (Muted)
  ];
  ...
  static const List<Color> cardColors = [
    Color(0xFF383A3D), // 0 - Default card
    Color(0xFF702B25), // 1 - Coral card (Deep Red)
    Color(0xFF166863), // 2 - Teal card (Deep Teal)
    Color(0xFF5E2E80), // 3 - Lavender card (Deep Purple)
    Color(0xFF3B6024), // 4 - Mint card (Deep Green)
    Color(0xFF806000), // 5 - Peach card (Deep Gold)
    Color(0xFF1F4E7A), // 6 - Sky card (Deep Blue)
  ];
