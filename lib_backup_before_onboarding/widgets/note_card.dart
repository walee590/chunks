...
class NoteCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final contentColor = isDark ? Colors.white : Colors.black.withValues(alpha: 0.85);
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: borderColor,
            width: isNeutral ? 2.0 : (note.pinned ? 1.5 : 1), // Thicker border
          ),
          boxShadow: [
            BoxShadow(
              ...
              if (note.content.isNotEmpty)
                if (note.isList)
                  ...
                  Text(
                    ...
                    color: contentColor,
                    height: 1.5,
                    // fontWeight: FontWeight.normal, // Let Roboto's natural weight shine
                  ),
                    maxLines: 6,
                    overflow: TextOverflow.ellipsis,
                  ),
